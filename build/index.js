...
var require_context = __commonJS({
  "node_modules/telegraf/lib/context.js"(exports) {
    "use strict";
    ...
    var Context = class {
      ...
      get webAppData() {
        if (!("message" in this.update && this.update.message && "web_app_data" in this.update.message))
          return void 0;
    ...
    var getThreadId = (ctx) => {
      ...
      return (msg === null || msg === void 0 ? void 0 : msg.is_topic_message) ? msg.message_thread_id : void 0;
    };
  }
});
...
var require_filters = __commonJS({
  "node_modules/telegraf/lib/filters.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_composer = __commonJS({
  "node_modules/telegraf/lib/composer.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
...
var require_compact = __commonJS({
  "node_modules/telegraf/lib/core/helpers/compact.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function compactOptions(options) {
      ...
      const compactKeys = keys.filter((key) => options[key] !== void 0);
...
var require_webhook = __commonJS({
  "node_modules/telegraf/lib/core/network/webhook.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
...
var require_error = __commonJS({
  "node_modules/telegraf/lib/core/network/error.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_polling = __commonJS({
  "node_modules/telegraf/lib/core/network/polling.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
...
var require_check = __commonJS({
  "node_modules/telegraf/lib/core/helpers/check.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_sandwich_stream = __commonJS({
  "node_modules/sandwich-stream/dist/sandwich-stream.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_multipart_stream = __commonJS({
  "node_modules/telegraf/lib/core/network/multipart-stream.js"(exports) {
    "use strict";
...
var require_client = __commonJS({
  "node_modules/telegraf/lib/core/network/client.js"(exports) {
    "use strict";
    var __createBinding = exports && exports.__createBinding || (Object.create ? function(o, m, k, k2) {
      if (k2 === void 0)
        k2 = k;
...
var require_util = __commonJS({
  "node_modules/telegraf/lib/util.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_formatting = __commonJS({
  "node_modules/telegraf/lib/core/helpers/formatting.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_format = __commonJS({
  "node_modules/telegraf/lib/format.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    Object.defineProperty(exports, "join", { enumerable: true, get: function() {
      return formatting_1.join;
    } });
    var fmt = (0, formatting_1._fmt)();
    exports.fmt = fmt;
    var bold = (0, formatting_1._fmt)("bold");
    exports.bold = bold;
    var italic = (0, formatting_1._fmt)("italic");
    exports.italic = italic;
    var spoiler = (0, formatting_1._fmt)("spoiler");
    exports.spoiler = spoiler;
    var strikethrough = (0, formatting_1._fmt)("strikethrough");
    exports.strikethrough = strikethrough;
    var underline = (0, formatting_1._fmt)("underline");
    exports.underline = underline;
    var code = (0, formatting_1._fmt)("code");
    exports.code = code;
    var pre = (language) => (0, formatting_1._fmt)("pre", { language });
    exports.pre = pre;
    var link = (content, url) => (0, formatting_1.linkOrMention)(content, { type: "text_link", url });
    exports.link = link;
    var mention = (name, user) => typeof user === "number" ? link(name, "tg://user?id=" + user) : (0, formatting_1.linkOrMention)(name, { type: "text_mention", user });
...
var require_telegram = __commonJS({
  "node_modules/telegraf/lib/telegram.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
...
var require_safe_compare = __commonJS({
  "node_modules/safe-compare/index.js"(exports, module2) {
    "use strict";
    ...
    module2.exports = typeof crypto.timingSafeEqual !== "undefined" ? nativeTimingSafeEqual : safeCompare;
  }
});

// node_modules/telegraf/lib/telegraf.js
var require_telegraf = __commonJS({
  "node_modules/telegraf/lib/telegraf.js"(exports) {
    "use strict";
    var __createBinding = exports && exports.__createBinding || (Object.create ? function(o, m, k, k2) {
      if (k2 === void 0)
        k2 = k;
    ...
    var Telegraf3 = class extends composer_1.Composer {
        ...
        this.webhookFilter = function(req) {
          ...
          if (req.method === "POST") {
            if (safeCompare(this.hookPath, req.url)) {
              ...
              debug2("Path does not match:", req.url, this.hookPath);
          } else
      ...
      secretPathComponent() {
        return crypto.createHash("sha3-256").update(this.token).update(process.version).digest("hex");
      }
      /**
...
var require_router = __commonJS({
  "node_modules/telegraf/lib/router.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
...
var require_button = __commonJS({
  "node_modules/telegraf/lib/button.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function userRequest(text2, request_id, user_is_premium, hide = false) {
      return { text: text2, request_user: { request_id, user_is_premium }, hide };
    }
    exports.userRequest = userRequest;
    function botRequest(text2, request_id, hide = false) {
      return { text: text2, request_user: { request_id, user_is_bot: true }, hide };
    }
...
var require_markup = __commonJS({
  "node_modules/telegraf/lib/markup.js"(exports) {
    "use strict";
    var __createBinding = exports && exports.__createBinding || (Object.create ? function(o, m, k, k2) {
      if (k2 === void 0)
        k2 = k;
...
var require_telegram_types = __commonJS({
  "node_modules/telegraf/lib/telegram-types.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_input = __commonJS({
  "node_modules/telegraf/lib/input.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_deunionize = __commonJS({
  "node_modules/telegraf/lib/deunionize.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_session = __commonJS({
  "node_modules/telegraf/lib/session.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
...
var require_context2 = __commonJS({
  "node_modules/telegraf/lib/scenes/context.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
...
var require_stage = __commonJS({
  "node_modules/telegraf/lib/scenes/stage.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
...
var require_base = __commonJS({
  "node_modules/telegraf/lib/scenes/base.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
...
var require_context3 = __commonJS({
  "node_modules/telegraf/lib/scenes/wizard/context.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_wizard = __commonJS({
  "node_modules/telegraf/lib/scenes/wizard/index.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
...
var require_scenes = __commonJS({
  "node_modules/telegraf/lib/scenes/index.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
...
var require_lib3 = __commonJS({
  "node_modules/telegraf/lib/index.js"(exports) {
    "use strict";
    var __createBinding = exports && exports.__createBinding || (Object.create ? function(o, m, k, k2) {
      if (k2 === void 0)
        k2 = k;
...
var require_package3 = __commonJS({
  "node_modules/node-persist/package.json"(exports, module2) {
    module2.exports = {
      name: "node-persist",
      version: "3.1.3",
...
var require_local_storage = __commonJS({
  "node_modules/node-persist/src/local-storage.js"(exports, module2) {
    var fs = require("fs");
    var path = require("path");
    var crypto = require("crypto");
          ...
          fs.exists(file, (exists) => {
            if (exists) {
              ...
              fs.unlink(file, (err) => {
                ...
                let result = { file, removed: !err, existed: exists };
              ...
              let result = { file, removed: false, existed: exists };
              resolve(result);
            }
          });
        });
...
var require_node_persist = __commonJS({
  "node_modules/node-persist/src/node-persist.js"(exports, module2) {
    ...
    (function(nodePersist) {
      ...
      nodePersist.init = async function(userOptions) {
        ...
        mixin(nodePersist, localStorage2, { skip: ["init", "create"] });
        return ret;
      };
...
var setUpStorage = () => __async(void 0, null, function* () {
  return yield import_node_persist.default.init({
    dir: "storage"
  });
});
var getUserData = (userID) => __async(void 0, null, function* () {
  let userData = yield import_node_persist.default.getItem(userID);
  if (!userData) {
    import_node_persist.default.setItem(userID, {});
    userData = {};
  }
  return userData;
});
var setUserData = (userID, userData) => __async(void 0, null, function* () {
...
var addWizard = (bot) => {
  const superWizard = new import_telegraf.Scenes.WizardScene(
    ...
    (ctx) => __async(void 0, null, function* () {
      yield ctx.reply("What's your 'Internal Integration Token' from Notion?");
      ctx.wizard.state.data = {};
      return ctx.wizard.next();
    }),
    (ctx) => __async(void 0, null, function* () {
      ctx.wizard.state.data.notionToken = ctx.message.text;
      yield ctx.reply("What is the link for the Notion Page you want to use?");
      return ctx.wizard.next();
    }),
    (ctx) => __async(void 0, null, function* () {
...
var setupBot = () => __async(void 0, null, function* () {
  ...
  bot.command("start", (ctx) => __async(void 0, null, function* () {
    yield ctx.replyWithMarkdownV2(PROMPT_TEXT);
    if (!hasUserInfo(ctx)) {
      yield ctx.scene.enter("setup");
    }
  }));
  bot.command("help", (ctx) => __async(void 0, null, function* () {
    yield ctx.replyWithMarkdownV2(PROMPT_TEXT);
    if (!hasUserInfo(ctx)) {
      yield ctx.scene.enter("setup");
    }
  }));
  bot.command("info", (ctx) => __async(void 0, null, function* () {
    yield ctx.reply(JSON.stringify(ctx.userData));
  }));
  bot.use((ctx, next) => __async(void 0, null, function* () {
    if (!hasUserInfo(ctx)) {
      yield ctx.scene.enter("setup");
